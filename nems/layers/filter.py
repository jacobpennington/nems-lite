...
class FiniteImpulseResponse(Layer):
    ...
    def evaluate(self, input):
        ...
        # Squeeze out singleton axes generated by extra data dimensions.
        output = np.concatenate(outputs, axis=2).squeeze()
        # But make sure there's still an output dimension
        if output.ndim == 1:
